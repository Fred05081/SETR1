...
\begin{DoxyCompactList}\small\item\em Lê o valor da A\+DC e guarda numa variável global (shared memory between tasks A/B) no nosso Código denominada por “ab” e no final faz give do semáforo AB. ~\newline
...
\begin{DoxyCompactList}\small\item\em Neste Script, feito o take do semáforo AB É efetuada a filtragem, em que é realizado a média das últimas 10 amostras calculadas na thread A e o filtro rejeita todos os valores que estejam abaixo ou acima de 10\% da média destas amostras e faz give do semáforo BD. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Modo Manual, sempre que se carregar no botão 2 incrementa a luminosidade e ao clicar no botão 4 a luminosidade do led decrementa igualmente, ou seja, sempre que um dos botões for pressionado, o P\+WM varia em ± 10\% do período deste, dependendo do botão que for pressionado. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Main funtion\+: Initialize semaphores and configure G\+P\+I\+O\+\_\+\+P\+IN. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Lê o valor da A\+DC e guarda numa variável global (shared memory between tasks A/B) no nosso Código denominada por “ab” e no final faz give do semáforo AB. ~\newline
...
Modo Manual, sempre que se carregar no botão 2 incrementa a luminosidade e ao clicar no botão 4 a luminosidade do led decrementa igualmente, ou seja, sempre que um dos botões for pressionado, o P\+WM varia em ± 10\% do período deste, dependendo do botão que for pressionado. 
...
\DoxyCodeLine{        printk(\textcolor{stringliteral}{"Valor lido para automatico \%d\(\backslash\)n\(\backslash\)r"},\mbox{\hyperlink{main_8c_ab36d1100473c16852c1b64d1917454a4}{bd}});}
\DoxyCodeLine{        ret=0;}
\DoxyCodeLine{        }
\DoxyCodeLine{}
...
\DoxyCodeLine{            \}}
\DoxyCodeLine{        \} }
\DoxyCodeLine{        \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(\mbox{\hyperlink{main_8c_ab36d1100473c16852c1b64d1917454a4}{bd}}>500 \&\& \mbox{\hyperlink{main_8c_ab36d1100473c16852c1b64d1917454a4}{bd}}<900) \{}
\DoxyCodeLine{            }
\DoxyCodeLine{            ret = pwm\_pin\_set\_usec(pwm0\_dev, \mbox{\hyperlink{main_8c_ad66f6c0ce6fd44d24653df422e7a8c92}{BOARDLED1}},}
\DoxyCodeLine{              pwmPeriod\_us,(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int})(pwmPeriod\_us*0.5), PWM\_POLARITY\_NORMAL);}
\DoxyCodeLine{            \textcolor{keywordflow}{if} (ret) \{}
\DoxyCodeLine{                printk(\textcolor{stringliteral}{"Error \%d: failed to set pulse width\(\backslash\)n"}, ret);}
\DoxyCodeLine{        \textcolor{keywordflow}{return};}
\DoxyCodeLine{            \}}
