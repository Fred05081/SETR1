...
\end{DoxyReturn}
A\+DC setup\+: bind and initialize

Gets one sample and checks for errors

A\+DC is set to use gain of 1/4 and reference V\+D\+D/4, so input range is \mbox{[}0...V\+D\+D\+\_\+3V\mbox{]}, with 10 bit resolution

Global variable ab will assume values between \mbox{[}0, 1023\mbox{]}\mbox{\Hypertarget{main_8c_a0bc8db7d99935e559b1164cf2e84e822}\label{main_8c_a0bc8db7d99935e559b1164cf2e84e822}} 
...
No returns 
\end{DoxyReturn}
Choose the values that are not acording to the average\mbox{\Hypertarget{main_8c_a05a8f93095731e110abe668f996166c9}\label{main_8c_a05a8f93095731e110abe668f996166c9}} 
...
No returns 
\end{DoxyReturn}
Pointer to G\+P\+IO device structure

Pointer to P\+WM device structure

Generic return value variable

P\+WM period in us

Bind to G\+P\+IO 0 and P\+W\+M0

Sets the P\+WM DC value to the average of the samples got from A\+DC module in thread A
